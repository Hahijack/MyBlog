...
from blog.models import UserProfile, Category, Article #导入站长及站长资料model

def site_info(request):
    '''站长资料、网站资料,所有分类上下文'''
    userinfo = UserProfile.objects.get(pk=1)#站长资料
    #siteinfo = Siteinform.objects.get(pk=1)#获取站点信息
    ...
    #'siteinfo':siteinfo
    return {'userinfo':userinfo,  'categorys':categorys,
